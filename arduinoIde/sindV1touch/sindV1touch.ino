...
// Define los pines según tu configuración específica
#define TFT_DC 21
#define TFT_CS 22
#define TFT_MOSI 23
#define TFT_CLK 18
#define TFT_RST 15
#define TFT_MISO -1  // No usado en este caso

// Inicializa la pantalla con los pines definidos
Adafruit_GC9A01A tft = Adafruit_GC9A01A(TFT_CS, TFT_DC, TFT_MOSI, TFT_CLK, TFT_RST, TFT_MISO);
