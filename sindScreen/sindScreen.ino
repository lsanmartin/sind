...
for (int i = 10; i >= 0; i--) {
Serial.print(i);
tft.fillScreen(ORANGE); // Limpia la pantalla
tft.setCursor(120, 120); // Ajusta la posición donde se mostrará el texto
tft.setTextColor(BLUE); // Establece el color del texto
tft.setTextSize(2); // Establece el tamaño del texto
tft.print(i); // Muestra el número de la cuenta regresiva
delay(1000); // Espera un segundo
}
tft.fillScreen(ORANGE); // Limpia la pantalla al final de la cuenta regresiva
}
